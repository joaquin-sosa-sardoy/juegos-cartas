...
export default function AmigosDeMierda() {
  const ALL_CARDS = useMemo(() => [
    ...
    { text: 'A partir de este año nos van a entregar un Novel a la falta de aseo personal. ¿Quién es nomidado?' },
    ...
    { text: 'Uno se nosotros cree que el mundo sería mejor sin salud pública. ¿Quién?' },
    ...
    { text: 'Ya es posible la clonación humana. ¿Quién se clona para poder coger consimo mismo?' },
